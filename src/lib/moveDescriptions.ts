...
export const MOVE_DESCRIPTIONS: Record<string, MoveInfo> = {
  ...
  B: {
    ...
    description: "Turn the BACK face like a clock (↻) — when looking from the back",
    emoji: "↻",
    arrowDir: "cw",
    color: "bg-blue-500",
  },
  "B'": {
    ...
    description: "Turn the BACK face backwards (↺) — when looking from the back",
    emoji: "↺",
    arrowDir: "ccw",
    color: "bg-blue-500",
  },
  B2: {
    ...
    description: "Turn the BACK face — TWO times!",
    emoji: "🔄",
    arrowDir: "two",
    color: "bg-blue-500",
  },
