...
export const MOVE_DESCRIPTIONS: Record<string, MoveInfo> = {
  ...
  B: {
    ...
    description: "Turn the BACK face so its top edge slides to the RIGHT (as seen from the front)",
    emoji: "➡️",
    arrowDir: "cw",
    color: "bg-blue-500",
  },
  "B'": {
    ...
    description: "Turn the BACK face so its top edge slides to the LEFT (as seen from the front)",
    emoji: "⬅️",
    arrowDir: "ccw",
    color: "bg-blue-500",
  },
  B2: {
    ...
    description: "Turn the BACK face — TWO times! (top goes right, then right again)",
    emoji: "🔄",
    arrowDir: "two",
    color: "bg-blue-500",
  },
